    ...
    <>
      ...
      <nav className="backdrop-blur-md bg-gray-900/90 text-white sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-6">
            <a href="#projects" aria-label="Lleva a la sección de los 'Proyectos'" className="hover:text-purple-400 transition-colors duration-300 relative group">
              Proyectos
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#about" aria-label="Lleva a la sección del 'Sobre mí'" className="hover:text-purple-400 transition-colors duration-300 relative group">
              Sobre mí
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#contact" aria-label="Lleva a la sección del 'Contacto'" className="hover:text-purple-400 transition-colors duration-300 relative group">
              Contacto
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </div>
          ...
          <button 
            ...
            aria-label="Botón del menú para el móvil"
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-800 py-4 px-4 animate-fadeIn">
            <div className="flex flex-col space-y-4">
              <a 
                href="#projects" 
                aria-label="Lleva a la sección de los 'Proyectos'"
              ...
              <a 
                href="#about" 
                aria-label="Lleva a la sección del 'Sobre mí'"
                className="text-white hover:text-purple-400 transition-colors duration-300 py-2"
                onClick={() => setIsMenuOpen(false)}
              >
                Sobre mí
              ...
              <a 
                href="#contact" 
                aria-label="Lleva a la sección del 'Contacto'"
                className="text-white hover:text-purple-400 transition-colors duration-300 py-2"
                onClick={() => setIsMenuOpen(false)}
              >
                Contacto
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      aria-label="Redirige a la página de la Web de Emprendimiento"
                      target="_blank"
                    ...
                    <a
                      ...
                      aria-label="Redirige al código en GitHub de la Web de Emprendimiento"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      aria-label="Redirige a la página de la App de Gasolineras"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-300"
                    >
                    ...
                    <a
                      ...
                      aria-label="Redirige al código en GitHub de la App de Gasolineras"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 text-purple-400 hover:text-purple-300 font-medium transition-colors duration-300"
                    >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      aria-label="Redirige al juego Eternal Descent en itch.io"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-300"
                    >
                    ...
                    <a
                      ...
                      aria-label="Redirige al código en GitHub del Eternal Descent"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 text-purple-400 hover:text-purple-300 font-medium transition-colors duration-300"
                    >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      aria-label="Redirige a la página del Clon de Spotify"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-300"
                    >
                    ...
                    <a
                      ...
                      aria-label="Redirige al código en GitHub del Clon de Spotify"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 text-purple-400 hover:text-purple-300 font-medium transition-colors duration-300"
                    >
      ...
      <section id="contact" className="py-20 px-4 bg-gradient-to-b from-indigo-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            <a href="mailto:altair555mu@gmail.com" aria-label="Redirige a mandar un correo electrónico a 'altair555mu@gmail.com'" className="w-36 flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full transition-colors duration-300 shadow-md hover:shadow-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
              </svg>
              <span>Email</span>
            </a>
            <a href="https://www.linkedin.com/in/antonio-mu%C3%B1oz-obreo-653385353/" aria-label="Redirige al perfil de LinKeDin" target="_blank" rel="noopener noreferrer" className="w-36 flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full transition-colors duration-300 shadow-md hover:shadow-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
              <span>LinkedIn</span>
            </a>
            <a href="https://github.com/antonio-munoz55" aria-label="Redirige al perfil de GitHub" target="_blank" rel="noopener noreferrer" className="w-36 flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full transition-colors duration-300 shadow-md hover:shadow-lg">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex justify-center">
            <a href="/download/CurriculumAntonioMunoz.pdf" download aria-label="Descarga el Curriculum Vitae" className="w-48 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-full transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
      ...
      <footer className="bg-gray-900 text-gray-400 py-10 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex space-x-4">
            <a href="https://x.com/Altair5552" aria-label="Redirige al perfil de X" className="text-gray-400 hover:text-white transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="https://www.facebook.com/profile.php?id=100011413407330" aria-label="Redirige al perfil de Facebook" className="text-gray-400 hover:text-white transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.instagram.com/antonio_mo55/" aria-label="Redirige al perfil de Instagram" className="text-gray-400 hover:text-white transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
